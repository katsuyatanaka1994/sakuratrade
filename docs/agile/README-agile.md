...
| `workorder.md` | 作業指示テンプレ | Codex + Devリード | 着手時 / 作業指示更新時 | AUTO: workorder.meta / workorder.limits / workorder.allowed_paths / workorder.blocked_paths / workorder.plan_links |
