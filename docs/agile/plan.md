...
- Doc ID: plan
- Updated at: 2025-11-08T15:20:21+09:00
- Related PRs: []
<!-- AUTO:END -->
...
-
  id: T-wo12-case1-smoke-update
  refs:
    - tests:integration:wo12-case1-smoke
  outputs:
    - docs/agile/ui-specification.md#wo12-case1-smoke
  acceptance:
    max_changed_lines: 80
    checks:
      - name: pytest
        command: pytest -q docs/agile/ui-specification.md#wo12-case1-smoke
  gate:
    []
  deps:
    []
...
-
  id: T-wo12-lite-case1-update
  refs:
    - tests:integration:wo12-lite-case1
  outputs:
    - docs/agile/ui-specification.md#wo12-lite-case1
  acceptance:
    max_changed_lines: 80
    checks:
      - name: pytest
        command: pytest -q docs/agile/ui-specification.md#wo12-lite-case1
  gate:
    []
  deps:
    []
