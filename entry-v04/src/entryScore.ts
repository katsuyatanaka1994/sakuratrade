...
export function scoreEntryV04(
  ...
  if (indicators.sma5 == null) missing.push('sma5');
  if (indicators.sma20 == null) missing.push('sma20');
  if (indicators.sma60 == null) missing.push('sma60');
  if (indicators.volMA5 == null) missing.push('volMA5');
  if (indicators.prevHigh == null) missing.push('prevHigh');
  if (indicators.prevLow == null) missing.push('prevLow');
  if (indicators.prevClose == null) missing.push('prevClose');
