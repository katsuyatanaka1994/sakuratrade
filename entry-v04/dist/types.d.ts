...
/** Candleパターン種別 */
export type CandlePattern = 'breakout_marubozu' | 'standard_breakout' | 'inside_breakout' | 'ma20_touch_reversal' | 'engulfing_at_ma20' | 'continuation_small_body' | 'generic_bullish' | 'other';
/** Candleスコア詳細 */
