 ...
 * @returns チェック結果
 */
function checkPivotExpiry(context, options) {
 ...
 * @returns チェック結果
 */
function checkPriceLocation(close, indicators, options) {
 ...
 * @returns 検証結果
 */
export function validateGate(close, indicators, context, options) {
    // 個別チェック実行
