 ...
 * @returns Pivot判定結果
 */
function scorePivotV13Mock(bar, indicators, _context = {}) {
 ...
 * @returns 総合判定
 */
function determineVerdict(pivot, entry) {
    if (!pivot.isPivot) {
        return '非推奨';
    }
    if (entry.label === '見送り') {
 ...
 * @returns 総合判定結果
 */
export function evaluateLongSetup(bar, indicators, context = {}) {
    // Pivot v1.3 判定
 ...
 * }
 */ 
//# sourceMappingURL=longSetup.js.map