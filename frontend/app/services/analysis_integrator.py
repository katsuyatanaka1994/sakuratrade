...
class AnalysisIntegrator:
    ...
    def _merge_indicators(self, rule_indicators: List[IndicatorItem], gpt_indicators: List[IndicatorItem]) -> List[IndicatorItem]:
        """重複するインジケーターをマージ"""
        merged = {}
    ...
    def _combine_evaluations(self, eval1: str, eval2: str) -> str:
        ...
        score_to_evaluation = {
            2: "強気", 1.5: "強気", 1: "やや強気", 0.5: "やや強気",
            0: "中立", -0.5: "やや弱気", -1: "やや弱気", -1.5: "弱気", -2: "弱気"
        }
