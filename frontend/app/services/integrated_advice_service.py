...
from schemas.indicators import TradingAnalysis, AnalysisResponse
...
def generate_simple_advice(
    ...
    user_prompt = f"この{symbol_context or '株価'}のチャート画像を解析し、{analysis_context or 'トレーディング'}のアドバイスを教えてください。"
