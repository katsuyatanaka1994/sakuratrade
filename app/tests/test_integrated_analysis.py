...
# テスト対象のモジュール
from app.schemas.indicators import IndicatorItem, TradingAnalysis
...
class TestAnalysisIntegrator:
    ...
    def test_merge_indicators(self, integrator):
        ...
        gpt_indicators = [
            IndicatorItem(
                name="出来高傾向（GPT）", value="増加", evaluation="やや強気", comment="GPT判定", source="gpt_analysis"
            ),
