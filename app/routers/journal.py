    ...
    try:
        ...
        for entry in entries:
            response_entries.append(JournalEntryResponse(
                ...
                feedback_next_actions=json.loads(entry.feedback_next_actions) if entry.feedback_next_actions else None,
...
async def get_trade_feedback(
    ...
    try:
        ...
        return FeedbackResponse(
            feedback_text=entry.feedback_text,
            chat_id=entry.chat_id,
            message_id=entry.feedback_message_id
        )
